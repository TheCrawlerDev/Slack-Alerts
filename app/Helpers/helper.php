<?php
	...
	// embaralha o array do meio para as pontas, ao fim o conteudo é colocado em uma order semi reversa em que o meio se torna as pontas
	...
	// força o rescan do observatory via curl
	...
	function formatarURL($replace,$url){
	 ...
	 // busca o dominio da url
	function url_path($url){
		return parse_url($url)['host'];
	}

	// busca as auditorias verificadas do lighthouse
	...
	// carrega uma url baseados nos parametros url,
	// post que representa o conteudo da requisição, acess_token, action que representa o metodo e a head da requisição
	...
	// envia um json via post para a url passada via parametro
	...
	// api do scrapestack que fornece buscas
	...
	// curl simples de uma pagina baseado em url, useragent e timeout
	...
	// transforma os elementos de um sitemap em vetor
	...
	// pesquisa uma expressão com base em uma string de inicio
	// pesquisarAfter("Desenvolvido por Alexandre Matos para simplex","Desenvolvido por"), retorna "Alexandre Matos para simplex"
	...
	// pesquisa uma expressão entre duas palavras
	// pesquisar("Desenvolvido por Alexandre Matos para simplex","Desenvolvido por","para simplex"), retorna "Alexandre Matos"
	...
	// pesquisa imagens em um testo html
	...
	// converte um timestamp para data e hora me formato humano
	...
	// gera uma string randomica com o tamanho escolhido
	...
	// transforma datas em formato de leitura (25/02/2021) em unix
	...
	// conecta ao mongo db e retorna a conexao
	...
	// faz uma pesquisa no mongodb baseada em um vetor de parametros e retorna um vetor como resposta
	...
	// gera um id do mongodb não randomico, baseado na string id, que ja é um hexadecimal
  function ObjectId($id){
		return new MongoDB\BSON\ObjectId($id);
	}

	// gera um id hexadecimal para um vetor que será salvo no mongodb
	function generateSubId_mongo($id){
		return hexdec($id)/(7000000000*70000000);
	}

	// traz as tags de um doc html
	...
	// transforma uma string em array baseado em varios criterios de split ou explode
	...
	// formata string para o banco de dados
	...
	// mostra se o valor 1 é maior que o valor 2 determinada uma porcentagem
